...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _express = __webpack_require__(/*! express */ \"express\");\n\nvar _express2 = _interopRequireDefault(_express);\n\nvar _models = __webpack_require__(/*! ../db/models */ \"./db/models/index.js\");\n\nvar _models2 = _interopRequireDefault(_models);\n\nvar _middleware = __webpack_require__(/*! ../src/middleware */ \"./src/middleware.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar router = _express2.default.Router({ mergeParams: true });\nvar Campground = _models2.default.Campground,\n    Comment = _models2.default.Comment,\n    User = _models2.default.User;\n\n\nrouter.get('/new', _middleware.isLoggedIn, function (req, res) {\n  Campground.findById(req.params.id).then(function (campground) {\n    res.render('comments/new', { campground: campground });\n  }).catch(function (err) {\n    return res.send(err);\n  });\n});\n\nrouter.post('/', _middleware.isLoggedIn, function (req, res) {\n  Campground.findById(req.params.id).then(function (campground) {\n    Comment.create({\n      text: req.body.comment.text,\n      campground_id: campground.id,\n      user_id: req.user.id\n    }).then(function () {\n      return res.redirect('/campgrounds/' + campground.id);\n    }).catch(function () {\n      return res.redirect('/campgrounds/');\n    });\n  }).catch(function (err) {\n    res.redirect('/campgrounds');\n  });\n});\n\nrouter.get('/:comment_id/edit', _middleware.isCommentOwner, function (req, res) {\n  Comment.findById(req.params.comment_id, {\n    include: [{\n      model: Campground,\n      as: 'campground'\n    }]\n  }).then(function (comment) {\n    res.render('comments/edit', { comment: comment });\n  }).catch(function (err) {\n    console.log(err);\n    res.redirect('campgrounds');\n  });\n});\n\nrouter.put('/:comment_id', _middleware.isCommentOwner, function (req, res) {\n  Comment.findById(req.params.comment_id).then(function (comment) {\n    if (!comment) {\n      req.flash('showMessage', 'Comment not found');\n      return res.redirect('back');\n    }\n    return comment.update(req.body.comment).then(function () {\n      res.redirect('/campgrounds/' + req.params.id);\n    }).catch(function (err) {\n      req.flash('showMessage', 'Something went wrong');\n      res.redirect('back');\n    });\n  }).catch(function (err) {\n    req.flash('showMessage', 'Something went wrong');\n    res.redirect('back');\n  });\n});\n\nrouter.delete('/:comment_id', _middleware.isCommentOwner, function (req, res) {\n  Comment.findById(req.params.comment_id).then(function (comment) {\n    if (!comment) {\n      req.flash('showMessage', 'Something went wrong');\n      return res.redirect('back');\n    }\n    return comment.destroy().then(function () {\n      res.redirect('/campgrounds/' + req.params.id);\n    }).catch(function (err) {\n      req.flash('showMessage', 'Something went wrong');\n      res.redirect('back');\n    });\n  }).catch(function (err) {\n    req.flash('showMessage', 'Something went wrong');\n    res.redirect('back');\n  });\n});\n\nexports.default = router;\n\n//# sourceURL=webpack:///./routes/comments.js?");
