...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _authentication = __webpack_require__(/*! ./controllers/authentication */ \"./controllers/authentication.js\");\n\nvar Auth = _interopRequireWildcard(_authentication);\n\nvar _middlewares = __webpack_require__(/*! ./middlewares */ \"./middlewares/index.js\");\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nexports.default = app => {\n  app.get('/feature', _middlewares.requireAuthorizationHeader, _middlewares.requireAuth, Auth.getFeature);\n  app.post('/signin', _middlewares.requireSignin, Auth.signin);\n  app.post('/signup', Auth.signup);\n};\n\n//# sourceURL=webpack:///./router.js?");
